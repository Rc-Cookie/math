...
/**
 * A 2D int vector with read-only access.
 */
...
public class constInt2 implements Cloneable<int2>, JsonSerializable {
     ...
     */
    public static final constInt2 zero = new constInt2(0);
    /**
     * A vector representing the x-axis unit vector.
     */
    public static final constInt2 X = new constInt2(1,0);
    /**
     * A vector representing the y-axis unit vector.
     */
    public static final constInt2 Y = new constInt2(0,1);
    /**
     * A vector with all components set to 1.
     */
    public static final constInt2 one = new constInt2(1);
    /**
     * A vector with all components set to 0.
     */
    public static final constInt2 minusOne = new constInt2(-1);
    /**
     * A vector with all components set to {@link Integer#MIN_VALUE}.
     */
    public static final constInt2 min = new constInt2(Integer.MIN_VALUE);
    /**
     * A vector with all components set to {@link Integer#MAX_VALUE}.
     */
    public static final constInt2 max = new constInt2(Integer.MAX_VALUE);
    ...
    public boolean equals(Object obj) {
        return obj instanceof constInt2 && equals((constInt2) obj);
    }
     ...
     */
    @Override
    public final @NotNull int2 clone() {
        return new int2(x,y);
    }
     ...
     */
    public final int component(@Range(from = 0, to = 1) int index) {
        switch(index) {
            case 0: return x;
            case 1: return y;
     ...
     */
    public final int4 xy00() {
        return new int4(x,y,0,0);
    }
    ...
    /**
     * Returns a {@link constInt2} object with identical values (which is <b>not</b> a
     * {@link int2} instance) to this vector. If <code>getClass() == constInt2.class</code> is
     ...
     */
    public final constInt2 toConst() {
        return getClass() == constInt2.class ? this : new constInt2(x,y);
    }
     ...
     */
    public final int dot(constInt2 v) {
        return x*v.x + y*v.y;
    }
     ...
     */
    public final int dist2(constInt2 v) {
     ...
     */
    public final int2 absolute() {
        return new int2(abs(x), abs(y));
    }
     ...
     */
    public final int2 added(int x) {
        return new int2(this.x + x, y+x);
    }
     ...
     */
    public final int2 added(int x, int y) {
     ...
     */
    public final int2 added(constInt2 v) {
     ...
     */
    public final int2 subed(int x, int y) {
        return new int2(this.x - x, this.y - y);
    }
     ...
     */
    public final int2 subed(constInt2 v) {
        return new int2(x - v.x, y - v.y);
    }
     ...
     */
    public final int2 scaled(int f) {
     ...
     */
    public final int2 scaled(int x, int y) {
        return new int2(this.x * x, this.y * y);
    }
     ...
     */
    public final int2 scaled(constInt2 v) {
        return new int2(x * v.x, y * v.y);
    }
     ...
     */
    public final int2 dived(int x, int y) {
        return new int2(this.x / x, this.y / y);
    }
     ...
     */
    public final int2 dived(constInt2 v) {
        return new int2(x / v.x, y / v.y);
    }
     ...
     * @return A new vector representing the division of this and the given vector
     */
    public final float2 divedF(constInt2 v) {
        return new float2((float) x / v.x, (float) y / v.y);
    }
    ...
    public final float2 projected(constInt2 onto) {
        float f = (x*onto.x + y*onto.y) / (float) (onto.x*onto.x + onto.y*onto.y);
     ...
     */
    @SuppressWarnings("SuspiciousNameCombination")
    public final int2 clamped(constInt2 min, constInt2 max) {
        return new int2(
     ...
     */
    @SuppressWarnings("SuspiciousNameCombination")
    public final int2 clamped(constIRect area) {
        return new int2(
